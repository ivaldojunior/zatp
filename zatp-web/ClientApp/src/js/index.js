(function() {
	...
	var API_KEY = '29yLgpKNTjGL3sAXPuujgA';
   ...
   */
	var API_SECRET = 'udq8zIl474VK29CEaddk7c5ORPSSUUIis9lL';

	// some help code, remember mn, pwd, lang to cookie, and autofill.
	document.getElementById('display_name').value =
		'CDN' + ZoomMtg.getJSSDKVersion()[0] + testTool.detectOS() + '#' + testTool.getBrowserInfo();
